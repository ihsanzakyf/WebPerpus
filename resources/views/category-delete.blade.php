...
<div class="container mt-5">
    <div class="card px-0">
        ...
        <div class="card-body">
            <h5>Apakah yakin Kategori, {{$category->slug}} akan dihapus ?</h5>
            <form style="display: inline-block" action="/category-destroy/{{$category->slug}}" method="POST" id="delete-form">
                @csrf
                @method('delete')
    ...
    <script>
        ...
        document.getElementById('delete-form').addEventListener('submit', function(event) {
            ...
            Swal.fire({
                ...
                text: "Kategori {{$category->slug}} akan dihapus!",
                icon: 'warning',
