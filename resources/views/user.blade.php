...
@endif
<div class="card">
    <h5 class="card-header fw-bold"># User List 
        <a href="/registered-user" class="btn btn-primary float-end" style="margin-right: 10rem"> New Register User</a>
            ...
            <table class="table text-center">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="/user-detail/{{$item->slug}}" class="btn btn-warning btn-sm">Detail</a>
                            <a href="/user-ban/{{$item->slug}}" class="btn btn-danger btn-sm">Banned</a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
